...
namespace CPE200Lab1
{
    public partial class MainForm : Form
    {
        ...
        private void btnOperator_Click(object sender, EventArgs e)
        {
            ...
            switch (operate)
            {
                ...
                case "÷":
                    ...
                    {
                        firstOperand = engine.calculate(operate2, firstOperand, lblDisplay.Text);
        ...
        {
            lblDisplay.Text = Convert.ToString(Math.Pow(Convert.ToDouble(lblDisplay.Text), 0.5));
            isAfterOperater = true;
        }

        private void btnOneoverx_Click(object sender, EventArgs e)
        {
            lblDisplay.Text = Convert.ToString(1 / Convert.ToDouble(lblDisplay.Text));
            isAfterOperater = true;
        }
    }
}
